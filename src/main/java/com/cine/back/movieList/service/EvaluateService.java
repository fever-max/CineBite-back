...
// @Transactional
// public void rateMovie(int movieId, String userId, String rating) throws
// Exception {
...
// userRatingRepository.findByUserIdAndMovieId(userId, movieId);
...
// public UserRating CreateUserRating(int movieId, String userId, String rating,
