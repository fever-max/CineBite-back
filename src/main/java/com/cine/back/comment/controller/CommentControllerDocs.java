...
public interface CommentControllerDocs {
        ...
        public ResponseEntity<CommentResponseDto> saveComment(@PathVariable(value = "no") Long PostNo,
        ...
        public ResponseEntity<Long> getAllComments(@PathVariable(value = "no") Long PostNo);
        ...
        @ApiResponses(value = {
                        @ApiResponse(responseCode = "200", description = "댓글 조회 성공"),
                        @ApiResponse(responseCode = "400", description = "댓글 조회 실패") })
        public ResponseEntity<Long> deleteCommentById(@PathVariable(value = "no") Long CommentNo);
